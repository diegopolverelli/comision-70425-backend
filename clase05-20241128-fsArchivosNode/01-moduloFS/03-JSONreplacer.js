...
const replacer=(clave, valor)=>{
    if(clave==="name") return valor.toUpperCase()
...
// fs.writeFileSync(rutaArchivo, JSON.stringify(heroes, ["name", "team"], "\t" ))
fs.writeFileSync(rutaArchivo, JSON.stringify(heroes, replacer, "\t" ))